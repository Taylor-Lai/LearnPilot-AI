...
| RAG 内容生成 | BM25 + TF-IDF + 轻量重排召回课程证据，Qwen 生成或离线模板回退 | `POST /generate` |
...
| 学习效果评估 | Recall/NDCG/MAP/MRR、覆盖度、多样性、先修合理性、生成质量、证据率、可解释率 | `GET /evaluate`、`learnpilot-ml-evaluate` |
